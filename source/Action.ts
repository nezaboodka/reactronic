...
export abstract class Action implements Worker {
  ...
  static runAs<T>(hint: string, spawn: boolean, sidebyside: boolean, trace: Partial<Trace> | undefined, token: any, func: F<T>, ...args: any[]): T { return Transaction.runAs<T>(hint, spawn, sidebyside, trace, token, func, ...args) }
