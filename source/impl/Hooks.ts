...
export class ReactiveArray<T> extends ReactiveObject {
  ...
  set(n: number, item: T): void { this.a[n] = item }
  ...
  push(...items: T[]): number { return this.push(...items) }
  concat(...items: (T | ConcatArray<T>)[]): T[]
  concat(...items: ConcatArray<T>[]): T[] { return this.concat(...items) }
  join(separator?: string): string { return this.a.join(separator) }
  reverse(): T[] { return this.a.reverse() }
  shift(): T | undefined { return this.a.shift() }
  slice(start?: number, end?: number): T[] { return this.a.slice(start, end) }
  sort(compareFn?: (a: T, b: T) => number): this { this.a.sort(compareFn); return this }
  splice(start: number, deleteCount?: number): T[]
  splice(start: number, deleteCount: number, ...items: T[]): T[] { return this.a.splice(start, deleteCount, ...items) }
  unshift(...items: T[]): number { return this.a.unshift(...items) }
