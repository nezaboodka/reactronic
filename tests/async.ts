...
import { stateful, transaction, cache, Renew, ConcurrentCall, ApartFrom, Monitor, monitor, Transaction } from "../src/z.index";
...
export class DemoView {
  ...
  @cache(Renew.Immediately, ConcurrentCall.ExitWithError, ApartFrom.Parent)
