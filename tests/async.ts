...
import { stateful, transaction, cache, Renew, ReentrantCall, ApartFrom, Monitor, monitor, Transaction } from "../src/z.index";
...
export class DemoView {
  ...
  @cache(Renew.Immediately, ReentrantCall.ExitWithError, ApartFrom.Parent)
