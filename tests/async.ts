...
import { stateful, transaction, cache, Renew, Reenter, Dispart, Monitor, monitor, Transaction } from "../src/z.index";
...
export class DemoView {
  ...
  @cache(Renew.Immediately, Reenter.Prevent, Dispart.FromParent)
