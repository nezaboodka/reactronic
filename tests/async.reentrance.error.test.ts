...
import { Transaction, ReentrantCalls, Reactronic, resultof, statusof, sleep } from '../source/reactronic';
...
test("async", async t => {
  ...
  statusof(app.model.load).configure({reentrant: ReentrantCalls.ExitWithError});
  try {
