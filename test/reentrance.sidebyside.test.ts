...
const expected: Array<string | undefined> = [
  ...
  'Error: T112[AsyncDemo.load #23 - microsoft.com] conflicts with: AsyncDemo.load #23 - nezaboodka.com (AsyncDemo.load #23t108v108), AsyncDemo.load #23 - nezaboodka.com (AsyncDemo.url #23t108v108), AsyncDemo.load #23 - nezaboodka.com (AsyncDemo.log #23t108v108)',
  'Url: nezaboodka.com',
  'Log: RTA, nezaboodka.com/100',
]
