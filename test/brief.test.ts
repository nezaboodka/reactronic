...
test('brief', t => {
  ...
  try {
    ...
    t.throws(() => console.log(zombi.age), { message: 'cannot use data from a transaction started after the current one T1[<none>]: Person.age #30 (head is T0[<empty>], uncommitted T125[op2])' })
