...
import { Transaction, Kind, atomicAction, nonreactive, sensitive, ReactiveSystem } from "../source/api.js"
...
test("brief", t => {
  ...
  try {
    ...
    t.throws(() => { console.log(ReactiveSystem.getOperation(daddy.setParent).options.indicator) }, { message: "given method is not decorated as reactronic one: setParent" })
    ...
    t.is(render.options.kind, Kind.cachedResult)
