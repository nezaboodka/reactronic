...
import { ObservableObject, cached, Transaction, Reactronic as R, options, reaction, unobservable } from 'api'
...
test('caching', t => {
  ...
  t.assert(demo.raw.startsWith('Demo.produceSideEffect #22t104v101   <<   called within Demo.produceSideEffect #22'))
