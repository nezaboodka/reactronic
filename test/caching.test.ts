...
test('Main', t => {
  ...
  t.throws(() => demo.produceSideEffect(), 'cache must have no side effects: #21 Demo.produceSideEffect should not change v103t106#21 Demo.title')
  t.throws(() => console.log(demo.unassigned), 'unassigned properties are not supported: v103t105#21 Demo.unassigned is used by T1 (<none>)')
})
