...
test('Main', t => {
  ...
  t.throws(() => demo.produceSideEffect(), 'cache must have no side effects: #21 Demo.produceSideEffect should not change v105t107#21 Demo.title')
  t.throws(() => console.log(demo.unassigned), 'unassigned properties are not supported: v105t106#21 Demo.unassigned is used by T1 (<none>)')
})
