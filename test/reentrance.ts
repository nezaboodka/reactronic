...
import { ObservableObject, apply, reaction, cache, options, Transaction, Indicator, Reentrance, ReactiveSystem, observable, all, pause } from "../source/api.js"
...
export class AsyncDemo extends ObservableObject {
  ...
  @apply @options({ indicator: busy, reentrance: Reentrance.preventWithError })
